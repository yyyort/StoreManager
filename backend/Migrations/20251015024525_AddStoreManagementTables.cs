    ...
    public partial class AddStoreManagementTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql(@"
                IF NOT EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[Users]') AND name = 'Avatar')
                BEGIN
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Drop Avatar column from Users table if reverting
            migrationBuilder.Sql(@"
                IF EXISTS (SELECT * FROM sys.columns WHERE object_id = OBJECT_ID(N'[Users]') AND name = 'Avatar')
                BEGIN
